...
{
    public class UnDeleteCommand : IRequest<Response<Domain.Entities.Type>>
    {
        [JsonIgnore]
    ...
    public class UnDeleteCommandHandler : IRequestHandler<UnDeleteCommand, Response<Domain.Entities.Type>>
    {
        ...
        public async Task<Response<Domain.Entities.Type>> Handle(UnDeleteCommand request, CancellationToken cancellationToken)
        {
            ...
            var res = _unitOfWork.TypeRepo.UnDelete(Type);
